...
class ConcordPayApi {
   ...
   * @since 3.8.0
   */
  protected const KEYS_FOR_RESPONSE_SIGNATURE = [
    'merchantAccount',
    'orderReference',
    'amount',
    'currency',
   ...
   * @since 3.8.0
   */
  protected const KEYS_FOR_REQUEST_SIGNATURE = [
    'merchant_id',
    'order_id',
    'amount',
    'currency_iso',
   ...
   * @since 3.8.0
   */
  protected const ALLOWED_OPERATION_TYPES = [
   ...
   *
   * @param array $data
   *   Order data, prepared for payment.
   *
   * @return string
   *
   * @since 3.8.0
